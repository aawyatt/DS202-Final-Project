...
```{r}
#ufo1 %>% ggplot(aes(x = long.border, y = lat.border)) + geom_path(aes(group = group)) +
#  geom_point(aes(x = longitude, y = as.numeric(latitude)))
```
...
From our graphs/visualizations, we conclude that the South region of the United States has the most UFO sightings between 1998 and 2014. 